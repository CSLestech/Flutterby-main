...
class _PredictionDetailsScreenState extends State<PredictionDetailsScreen>
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: TabBarView(
          controller: _tabController,
          children: [
            // To switch between layouts, uncomment ONE of these lines and comment the other:
            _buildOverviewTab(), // Option 1: Image → Analysis Summary → Result Card
            //_buildOverviewTabAlt(), // Option 2: Image → Result Card → Analysis Summary
            _buildBreakdownTab(),
            _buildDetailsTab(),
          ],
        ),
  ...
  // Option 1: Visual Analysis -> Analysis Summary -> Result Card
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // 2. Analysis Summary section second (Option 1)
          const Text(
            "Analysis Summary",
            style: TextStyle(
              fontSize: 22,
  ...
  // Option 2: Visual Analysis -> Result Card -> Analysis Summary
  Widget _buildOverviewTabAlt() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
